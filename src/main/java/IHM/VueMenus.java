...
import ressources.gamedata.ProfilData;
...
public class VueMenus extends JPanel  {
    ...
    private void loadProfil() {
        ...
        this.profils = new ProfilData(ligneLue.split(" "));
    }
...
/*
        // COUPLER CHAQUE ACTIONS AVEC SA CLASSE.. VU QUE LES CLASSES EXISTENT DEJA C EST WORTH
	...
	public void majFichierProfils(ProfilData p) {
