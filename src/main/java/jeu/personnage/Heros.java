...
import exceptions.ErreurGadgetException;
...
public class Heros extends Personnage {
	...
	/** utiliserInv
	 * 
	 * @param 	utiliser gadget a utiliser
	 * @throws	InventaireVideException
	 * @throws	ErreureGadgetException
	 */
	public void utiliserInv(Gadget element) {
