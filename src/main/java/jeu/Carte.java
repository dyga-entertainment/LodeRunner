...
/**
 * Classe Carte. Permet d'organiser la matrice de jeu.
 * 
 * @author Axel Grau
 * @version 1.0
 *
...
public class Carte {
	...
	public Bloc getBloc(Coordonnees pos) {
	...
	public Item getItem(Coordonnees pos) {
	...
	public boolean noItem(Coordonnees coord) {
