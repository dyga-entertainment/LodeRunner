...
public class ThreadPiste extends Thread{
	...
	public void run(){
		try {
			URL url = getClass().getResource(this.cheminFichierAudio);
			...
			System.out.println("Format du fichier audio non supporté.");
		} catch (LineUnavailableException ex2) {
			System.out.println("Accès à la progression de la lecture impossible.");
		} catch (IOException ex3) {
			System.out.println("Erreur lors de la lecture du fichier audio : " + cheminFichierAudio);
		}
		return;
	}
