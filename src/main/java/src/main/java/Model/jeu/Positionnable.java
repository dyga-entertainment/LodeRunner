...
public abstract class Positionnable extends Observable {
	...
	private Model.jeu.Sprite sprite;
	/** Les coordonnes sur la matrice de ce positionnable */
	private Model.jeu.Coordonnees position;
	/** Les coordonnees en pixels de ce positionnable */
	private Model.jeu.Coordonnees pixels;
	 ...
	 * @param img son image
	 */
	public Positionnable(Model.jeu.Coordonnees position, String img) {
		this.position = position;
		this.pixels = new Model.jeu.Coordonnees(this.position.getX() * 32, this.position.getY() * 32);
		this.sprite = new Model.jeu.Sprite(img, this.pixels);
	 ...
	 */
	public Model.jeu.Coordonnees getPosition() {
		return position;
	}
	 ...
	 */
	public Model.jeu.Coordonnees getPixels() {
		return this.pixels;
	}
	 ...
	 */
	public void setPosition(Model.jeu.Coordonnees position) {
		this.position = position;
...
//		System.out.println("MAJ deplacement");
	 ...
	 */
	public Model.jeu.Sprite getSprite() {
		return sprite;
	}
