...
import Model.jeu.Positionnable;
...
//                	System.out.println(p.getClass().toString());
                ...
                switch(p.getClass().toString()) {
                    case "class BlocTerre":
                        ...
                        break;
                    case "class Model.jeu.PetiteBombe":
...
//                                System.out.println("Pause");
                    ...
                    case "class Model.jeu.Heros":
                        ...
                        break;
                    case "class Model.jeu.BlocPortailFinNiveau":
                        try {
                            Thread.sleep(400);
                        } catch (InterruptedException ex) {
                            Logger.getLogger(Bloc.class.getName()).log(Level.SEVERE, null, ex);
