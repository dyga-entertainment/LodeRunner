...
public class IHM6 extends JPanel {
    ...
    public JPanel afficherProfil(Joueur j){
        ...
        JLabel avancement = new JLabel("jeu.Niveau debloque  :  ".concat(String.valueOf(j.getUnlockedWorld()).concat("-".concat(String.valueOf(j.getUnlockedLevel())))));
