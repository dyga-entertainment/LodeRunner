...
import jeu.Monde;
import levels.MondeDemonstration;
...
public class LevelSelectionView extends View {
    ...
    public void setupButtonsPanel() {
        ...
        previousPreview.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("[View parameters] " + parameters.toString());
            }
        });
    ...
    public void setup(int windowWidth, int windowHeight, int contentPanelWidth, int contentPanelHeight) {
        ...
        if(this.parameters != null) {
            System.out.println("[View parameters] " + this.parameters.toString());
        }
        ...
        // Retrieve all the levels from the selected world
        // Takes time
        // TODO
