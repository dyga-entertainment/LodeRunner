...
public class SoundSystem {
	...
	/* Nom : ajouterPiste
	 * Semantique : Permet de lancer un thread jouant un fichier audio sans bloquer le programme appelant
	 ...
	 * 				String cheminFichierAudio : adresse du fichier audio que l'on souhaite jouer
