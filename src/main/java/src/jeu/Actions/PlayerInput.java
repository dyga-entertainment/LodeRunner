...
//			System.out.println(fini);
        ...
        if (!fini) {
            ...
            if (getHeros().isRegardeAGauche()) {
                // Animation a gauche
                jeu.Positionnable.GESTION_ANIM.ajouterPositionnableAnime(getHeros(), Images.deathRight);
            } else {
                jeu.Positionnable.GESTION_ANIM.ajouterPositionnableAnime(getHeros(), Images.deathLeft);
            }
            ...
            jeu.Positionnable.GESTION_ANIM.ajouterPositionnableAnime(getHeros(), Images.win);
            try {
                Thread.sleep(6000);
