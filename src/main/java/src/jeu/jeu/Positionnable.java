...
/**
 * Classe abstraite jeu.Positionnable. Permet au modele de deplacer les objets de ce
 * type.
 * 
 * @author Axel Grau
 * @version 1.0
...
public abstract class Positionnable extends Observable {
	 ...
	 * @param img son image
	 */
	public Positionnable(jeu.Coordonnees position, String img) {
		this.position = position;
		this.pixels = new jeu.Coordonnees(this.position.getX() * 32, this.position.getY() * 32);
		this.sprite = new jeu.Sprite(img, this.pixels);
                //jeu.Positionnable.gestionnaireAnim;
	}
	 ...
	 */
	public jeu.Coordonnees getPosition() {
		return position;
	}
	 ...
	 */
	public jeu.Coordonnees getPixels() {
		return this.pixels;
	}
	 ...
	 */
	public void setPosition(jeu.Coordonnees position) {
		this.position = position;
