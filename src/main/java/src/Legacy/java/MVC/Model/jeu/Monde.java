...
public class Monde {
	...
	private List<MVC.Model.jeu.Niveau> Niveaux;
	/** Fond du Monde */
	private String fond;
	/* ***** ***** ********* ***** ***** */
	...
	public Monde(String nom, String background){
		this.Nom = nom;
		this.Niveaux = new ArrayList<MVC.Model.jeu.Niveau>();
	...
	public MVC.Model.jeu.Niveau getNiveau(int i){
		return this.Niveaux.get(i);
	}
	
	public void addNiveau(MVC.Model.jeu.Niveau lvl){
		lvl.setTheme(this.fond);
		this.Niveaux.add(lvl);
	}
	
	public void addNiveauTemp(MVC.Model.jeu.Niveau lvl) {
		this.Niveaux.add(lvl);
	}
