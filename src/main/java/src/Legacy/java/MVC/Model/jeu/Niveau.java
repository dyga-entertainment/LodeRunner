...
public class Niveau {
	...
	private Queue<MVC.Model.jeu.Coordonnees> originesMadMonks;
	/** coordonnees du heros */
	private MVC.Model.jeu.Coordonnees origineHeros;
	/** image de fond */
	...
	public Niveau(boolean estEditable) {
		...
		this.originesMadMonks = new LinkedList<MVC.Model.jeu.Coordonnees>();
		this.scoreFinal = 0;
	...
	public BlocPortailFinNiveau getTheEnd() {
		...
		MVC.Model.jeu.Coordonnees pos;
		Bloc bloc;
		Item item;
		Random rd = new Random();
		for (int i = 0; i < 20; i++) {
			for (int j = 0; j < 30; j++) {
                            pos = new MVC.Model.jeu.Coordonnees(j, i);
	...
	public void ajouterHeros(MVC.Model.jeu.Coordonnees pos) {
		this.origineHeros = new MVC.Model.jeu.Coordonnees(pos.getX(), pos.getY());
	}

	public void ajouterMadMonk(MVC.Model.jeu.Coordonnees pos) {
	...
	public Queue<MVC.Model.jeu.Coordonnees> recupererPosMadMonk() {
		return originesMadMonks;
	}

	public MVC.Model.jeu.Coordonnees posHeros() {
		return origineHeros;
	}
