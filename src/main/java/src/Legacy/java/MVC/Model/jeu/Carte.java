...
/**
 * Classe Carte. Permet d'organiser la matrice de MVC.Model.jeu.
 * 
 * @author Axel Grau
 * @version 1.0
 *
...
public class Carte {
	...
	public Bloc getBloc(MVC.Model.jeu.Coordonnees pos) {
	...
	public Item getItem(MVC.Model.jeu.Coordonnees pos) {
	...
	public boolean noItem(MVC.Model.jeu.Coordonnees coord) {
