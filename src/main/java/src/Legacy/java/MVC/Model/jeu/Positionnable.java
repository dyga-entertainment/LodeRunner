...
public abstract class Positionnable extends Observable {
	...
	private MVC.Model.jeu.Sprite sprite;
	/** Les coordonnes sur la matrice de ce positionnable */
	private MVC.Model.jeu.Coordonnees position;
	/** Les coordonnees en pixels de ce positionnable */
	private MVC.Model.jeu.Coordonnees pixels;
	 ...
	 * @param img son image
	 */
	public Positionnable(MVC.Model.jeu.Coordonnees position, String img) {
		this.position = position;
		this.pixels = new MVC.Model.jeu.Coordonnees(this.position.getX() * 32, this.position.getY() * 32);
		this.sprite = new MVC.Model.jeu.Sprite(img, this.pixels);
	 ...
	 */
	public MVC.Model.jeu.Coordonnees getPosition() {
		return position;
	}
	 ...
	 */
	public MVC.Model.jeu.Coordonnees getPixels() {
		return this.pixels;
	}
	 ...
	 */
	public void setPosition(MVC.Model.jeu.Coordonnees position) {
		this.position = position;
...
//		System.out.println("MAJ deplacement");
	 ...
	 */
	public MVC.Model.jeu.Sprite getSprite() {
		return sprite;
	}
