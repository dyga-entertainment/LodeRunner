 ...
 */
package MVC.Model.Actions;

import MVC.Model.bloc.Bloc;
import MVC.Model.bloc.BlocPortailFinNiveau;
import MVC.Model.bloc.BlocTerre;
import Utils.exceptions.AnimationNonReconnueException;
import Utils.helper.Images;
import MVC.Model.item.PetiteBombe;
import MVC.Model.jeu.Carte;
import MVC.Model.jeu.Coordonnees;
import MVC.Model.jeu.Positionnable;
...
//                	System.out.println(p.getClass().toString());
                ...
                switch(p.getClass().toString()) {
                    case "class BlocTerre":
                        ...
                        break;
                    case "class MVC.Model.jeu.PetiteBombe":
...
//                                System.out.println("Pause");
                        ...
                        break;
                    case "class MVC.Model.jeu.Heros":
                        try {
                            Thread.sleep(300);
                        } catch (InterruptedException ex) {
                            Logger.getLogger(Bloc.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        break;
                    case "class MVC.Model.jeu.BlocPortailFinNiveau":
                        try {
                            Thread.sleep(400);
                        } catch (InterruptedException ex) {
                            Logger.getLogger(Bloc.class.getName()).log(Level.SEVERE, null, ex);
