...
public class GameContentView extends JPanel implements Observer {
    ...
    public GameContentView(MainModelLegacy m) {
        ...
        Utils.helper.Images i = new Utils.helper.Images();
        Utils.helper.ImagesMadMonk j = new Utils.helper.ImagesMadMonk();
