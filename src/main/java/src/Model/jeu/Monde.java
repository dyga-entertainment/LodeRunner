...
public class Monde {
	...
	private List<Model.jeu.Niveau> Niveaux;
	/** Fond du Monde */
	private String fond;
	/* ***** ***** ********* ***** ***** */
	...
	public Monde(String nom, String background){
		this.Nom = nom;
		this.Niveaux = new ArrayList<Model.jeu.Niveau>();
	...
	public Model.jeu.Niveau getNiveau(int i){
		return this.Niveaux.get(i);
	}
	
	public void addNiveau(Model.jeu.Niveau lvl){
		lvl.setTheme(this.fond);
		this.Niveaux.add(lvl);
	}
	
	public void addNiveauTemp(Model.jeu.Niveau lvl) {
		this.Niveaux.add(lvl);
	}
