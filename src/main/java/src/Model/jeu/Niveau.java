...
public class Niveau {
	...
	private Queue<Model.jeu.Coordonnees> originesMadMonks;
	/** coordonnees du heros */
	private Model.jeu.Coordonnees origineHeros;
	/** image de fond */
	...
	public Niveau(boolean estEditable) {
		...
		this.originesMadMonks = new LinkedList<Model.jeu.Coordonnees>();
		this.scoreFinal = 0;
	...
	public BlocPortailFinNiveau getTheEnd() {
		...
		Model.jeu.Coordonnees pos;
		Bloc bloc;
		Item item;
		Random rd = new Random();
		for (int i = 0; i < 20; i++) {
			for (int j = 0; j < 30; j++) {
                            pos = new Model.jeu.Coordonnees(j, i);
	...
	public void ajouterHeros(Model.jeu.Coordonnees pos) {
		this.origineHeros = new Model.jeu.Coordonnees(pos.getX(), pos.getY());
	}

	public void ajouterMadMonk(Model.jeu.Coordonnees pos) {
	...
	public Queue<Model.jeu.Coordonnees> recupererPosMadMonk() {
		return originesMadMonks;
	}

	public Model.jeu.Coordonnees posHeros() {
		return origineHeros;
	}
