...
/**
 * Classe Carte. Permet d'organiser la matrice de Model.jeu.
 * 
 * @author Axel Grau
 * @version 1.0
 *
...
public class Carte {
	...
	public Bloc getBloc(Model.jeu.Coordonnees pos) {
	...
	public Item getItem(Model.jeu.Coordonnees pos) {
	...
	public boolean noItem(Model.jeu.Coordonnees coord) {
